...
DATA = [
    ...
    {
        'title': '«Краснодар» разгромил новичка '
                 'РПЛ и вышел на третье место',
        'date': 'Sat, 23 Oct 2021 15:51:57 +0300',
        'link': 'https://lenta.ru/news/2021/10/23/tretyemesto/',
        'author': 'Алексей Гусев',
        'category': ['Спорт'],
        'description': '«Краснодар» на выезде обыграл «Нижний Новгород»'
                       ' в матче 12-го тура Российской премьер-лиги'
                       ' (РПЛ). Встреча прошла в субботу, 23 октября, '
                       'и завершилась со счетом 4:1 в пользу гостей. '
                       'Одержать разгромную победу краснодарцам '
                       'позволили голы Гжегожа Крыховяка, '
                       'Эдуарда Сперцяна, '
                       'Александра Черникова и Владимира Ильина.',
        'more_description': None,
        'comments': None,
        'media_object': 'https://icdn.lenta.ru/images/2021/10/'
                        '23/15/20211023154554818/'
                        'pic_fbc5daebf5e79eab60893757b5d7f532.jpg',
        'extra_links': 'https://lenta.ru/news/2021/10/23/tretyemesto/',
        'source_feed': None
    },
    {
        'title': 'Потомков западных интервентов '
                 'в России призвали изучать историю',
        'date': 'Sat, 23 Oct 2021 15:39:00 +0300',
        'link': 'https://lenta.ru/news/2021/10/23/naryshkin_/',
        'author': 'Варвара Кошечкина',
        'category': ['Россия'],
        'description': 'Западные страны, которые в прошлом '
                       'планировали захватить Россию, '
                       'должны как следует изучать историю, '
                       'чтобы смириться с невыполнимостью '
                       'подобных надежд. С таким заявлением '
                       'выступил глава Службы внешней разведки'
                       ' России Сергей Нарышкин в ходе '
                       'церемонии награждения победителей '
                       'Всероссийского конкурса краеведов.',
        'more_description': None,
        'comments': None,
        'media_object': 'https://icdn.lenta.ru/images/2021/'
                        '10/23/15/20211023151836599/'
...
def test_console_output_feed(capsys):
    ...
    output = f'\n\nFeed source: {DATA[0]["source"]}\n' \
             ...
             f'{"-" * last_line[1]}\n\n' \
             f'{"-" * first_line_2[0]}{first_line_2[2]}' \
             f'{"-" * first_line_2[1]}\n' \
